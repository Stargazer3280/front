...
<script>
    export default {
        ...
        methods: {
            ...
            async getData() {
                const _this = this;
                await axios.get('http://49.235.13.152:8181/information/get/civilStructure', {params: {no: this.no}}).then(function (resp) {
            ...
            update() {
                this.$refs.formRef.validate(async valid => {
                    ...
                    if (!valid) return;
                    //valid为真则发送数据并登录
                    const {data: result} = await axios.post('http://49.235.13.152:8181/information/update/civilStructure', this.form);
